...
object Settings {
    ...
    val MinimumDistanceBetweenOrbits : Int get() { return ConfigHolder.config["MinimumDistanceBetweenOrbits", 7000] as Int }
    ...
    val RotatePlanets = ConfigHolder.config["RotatePlanets", true] as Boolean
}