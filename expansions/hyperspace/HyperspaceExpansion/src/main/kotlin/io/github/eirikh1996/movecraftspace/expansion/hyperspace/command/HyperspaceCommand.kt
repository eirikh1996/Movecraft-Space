...
import io.github.eirikh1996.movecraftspace.expansion.hyperspace.Movecraft7HyperspaceProcessor
...
object HyperspaceCommand : TabExecutor {
    ...
    class Movecraft7Processor : MovecraftProcessor<Craft>() {
        override fun executePulloutCommand(sender: Player, args: Array<out String>) {
            ...
            val hsProcessor = HyperspaceManager.processor as Movecraft7HyperspaceProcessor
        ...
        override fun executeTravelCommand(sender: Player, args: Array<out String>) {
            ...
            (HyperspaceManager.processor as Movecraft7HyperspaceProcessor).scheduleHyperspaceTravel(craft, foundLoc, destination!!, str, true)
