...
class Movecraft8HyperspaceTravelEntry(craft : Craft, origin : Location, destination : Location, beaconTravel : Boolean = false) : HyperspaceTravelEntry<Craft>(craft, origin, destination, beaconTravel) {
    init {
